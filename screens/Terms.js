        ...
        <View style={look.topBox}>
          <View style={{ marginBottom: "2%" }}>
            <Text style={{ color: "#D7DAE5" }}>
              ...
              Service apply to all users of the App, including without
              limitation users who are browsers, vendors, customers, merchants,
              and/ or contributors of content. Please read these Terms of
              Service carefully before accessing or using our App. By accessing
              or using any part of the site, you agree to be bound by these
              Terms of Service. If you do not agree to all the terms and
              conditions of this agreement, then you may not access the App or
              use any Services. If these Terms of Service are considered an
              offer, acceptance is expressly limited to these Terms of Service.
              Any new features or tools which are added to the application shall
              ...
              App. It is your responsibility to check this page periodically for
              changes. Your continued use of or access to the App following the
          ...
          <View style={{ marginBottom: "2%" }}>
            <Text style={{ color: "#D7DAE5" }}>
              ...
              the right to refuse any order you place with us.
            </Text>
          </View>
          <View style={{ marginBottom: "2%" }}>
            <Text style={{ color: "#D7DAE5" }}>
