      ...
      <ScrollView>
        <View style={look.topBox}>
          <View style={{ marginBottom: "2%" }}>
            <Text style={{ color: "#D7DAE5" }}>
              TERMS OF SERVICE ---- OVERVIEW This Application is operated by
              Diffit.io. Throughout the App, the terms “we”, “us” and “our”
              refer to Diffit.io. Diffit.io offers this App, including all
              ...
              App. By accessing or using any part of the site, you agree to be
              ...
              the App or use any Services. If these Terms of Service are
              ...
              and/or changes to our App. It is your responsibility to check this
              page periodically for changes. Your continued use of or access to
              the App following the posting of any changes constitutes
              acceptance of those changes. Our store is hosted on Shopify Inc.
              They provide us with the online e-commerce platform that allows us
              to sell our products and Services to you.
            </Text>
          </View>
          <View style={{ marginBottom: "2%" }}>
            <Text style={{ color: "#D7DAE5" }}>
              SECTION 1 - ONLINE TERMS By agreeing to these Terms of Service,
              you represent that you are at least the age of majority in your
              state or province of residence, or that you are the age of
          ...
          <View style={{ marginBottom: "2%" }}>
            <Text style={{ color: "#D7DAE5" }}>
              ...
              your content may be transferred unencrypted and involve (a)
              ...
              the Service, or access to the Service or any contact on the App
          ...
          <View style={{ marginBottom: "2%" }}>
            <Text style={{ color: "#D7DAE5" }}>
              ...
              sources of information such as qualified medical professionals, of
              which we are not. Any reliance on the material on this site is at
          ...
          <View style={{ marginBottom: "2%" }}>
            <Text style={{ color: "#D7DAE5" }}>
              ...
              part or content thereof) without notice at any time. We shall not
          ...
          <View style={{ marginBottom: "2%" }}>
            <Text style={{ color: "#D7DAE5" }}>
              SECTION 5 - PRODUCTS OR SERVICES (if applicable) Certain products
              or Services may be available exclusively online through the App.
              ...
              without notice, at the sole discretion of us. We reserve the right
              to discontinue any product at any time. Any offer for any product
          ...
          <View style={{ marginBottom: "2%" }}>
            <Text style={{ color: "#D7DAE5" }}>
              ...
              the right to refuse any order you place with us. We may, in our
              sole discretion, limit or cancel quantities purchased per person,
          ...
          <View style={{ marginBottom: "2%" }}>
            <Text style={{ color: "#D7DAE5" }}>
              SECTION 7 - OPTIONAL TOOLS We may provide you with access to
              ...
              from or relating to your use of optional third-party tools. Any
              ...
              in the future, offer new Services and/or features through the App
          ...
          <View style={{ marginBottom: "2%" }}>
            <Text style={{ color: "#D7DAE5" }}>
              SECTION 8 - THIRD-PARTY LINKS Certain content, products and
              ...
              third-party Apps that are not affiliated with us. We are not
              ...
              other materials, products, or Services of third-parties. We are
              not liable for any harm or damages related to the purchase or use
              of goods, Services, resources, content, or any other transactions
              made in connection with any third-party Apps. Please review
          ...
          <View style={{ marginBottom: "2%" }}>
            <Text style={{ color: "#D7DAE5" }}>
              ...
              of the Service or any related App. You may not use a false e-mail
          ...
          <View style={{ marginBottom: "2%" }}>
            <Text style={{ color: "#D7DAE5" }}>
              ...
              information through the App is the responisibility of you the
              end-user. Data is stored on your device in an unencrypted state.
              The App contains email functionality and who you choose to send
              emails to is determined by you. The security of the notes, entries
              and information is the responisibility of the end-user. Diffit.io,
              Tremedy and it's creator assume no responisibility for the sharing
              of personal information contained in the application.
            </Text>
          </View>
          <View style={{ marginBottom: "2%" }}>
            <Text style={{ color: "#D7DAE5" }}>
              SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS Occasionally there
              ...
              in the Service or on any related App is inaccurate at any time
              without prior notice (including after you have submitted your
              order). We undertake no obligation to update, amend or clarify
              information in the Service or on any related App, including
              ...
              on any related App, should be taken to indicate that all
              information in the Service or on any related App has been modified
              or updated.
            </Text>
          </View>
          <View style={{ marginBottom: "2%" }}>
            <Text style={{ color: "#D7DAE5" }}>
              SECTION 12 - PROHIBITED USES In addition to other prohibitions as
              set forth in the Terms of Service, you are prohibited from using
              the site or its content: (a) for any unlawful purpose; (b) to
              ...
              the Service or of any related App, other Apps, or the Internet;
              ...
              the security features of the Service or any related App, other
              Apps, or the Internet. We reserve the right to terminate your use
              of the Service or any related App for violating any of the
              prohibited uses.
            </Text>
          </View>
          <View style={{ marginBottom: "2%" }}>
            <Text style={{ color: "#D7DAE5" }}>
              SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY We
              do not guarantee, represent or warrant that your use of our
              ...
              case shall Diffit.io, our directors, officers, employees,
          ...
          <View style={{ marginBottom: "2%" }}>
            <Text style={{ color: "#D7DAE5" }}>
              SECTION 14 - INDEMNIFICATION You agree to indemnify, defend and
              hold harmless Diffit.io and our parent, subsidiaries, affiliates,
          ...
          <View style={{ marginBottom: "2%" }}>
            <Text style={{ color: "#D7DAE5" }}>
              ...
              Terms of Service is determined to be unlawful, void or
              unenforceable, such provision shall nonetheless be enforceable to
              the fullest extent permitted by applicable law, and the
          ...
          <View style={{ marginBottom: "2%" }}>
            <Text style={{ color: "#D7DAE5" }}>
              SECTION 17 - ENTIRE AGREEMENT The failure of us to exercise or
              ...
              Service and any policies or operating rules posted by us on this
              site or in respect to The Service constitutes the entire agreement
          ...
          <View style={{ marginBottom: "2%" }}>
            <Text style={{ color: "#D7DAE5" }}>
              ...
              agreements whereby we provide you Services shall be governed by
          ...
          <View style={{ marginBottom: "2%" }}>
            <Text style={{ color: "#D7DAE5" }}>
              ...
              changes to our App. It is your responsibility to check our App
              periodically for changes. Your continued use of or access to our
              App or the Service following the posting of any changes to these
              Terms of Service constitutes acceptance of those changes.
            </Text>
          </View>
          <View style={{ marginBottom: "2%" }}>
            <Text style={{ color: "#D7DAE5" }}>
              SECTION 20 - CONTACT INFORMATION Questions about the Terms of
              Service should be sent to us at contact@diffit.io.
            </Text>
          </View>
        </View>
      </ScrollView>
